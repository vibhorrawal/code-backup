...
set rc [catch {
  ...
  add_files -quiet C:/Users/vibho/xilinx_projects/project_2_ripple_ca/project_2_ripple_ca.runs/synth_1/ripple_adder.dcp
  link_design -top ripple_adder -part xc7a100tftg256-1
