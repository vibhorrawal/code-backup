...
HD_PWD='C:/Users/vibho/xilinx_projects/project_3/project_3.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log buffer_blocking_nonblocking.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source buffer_blocking_nonblocking.tcl
