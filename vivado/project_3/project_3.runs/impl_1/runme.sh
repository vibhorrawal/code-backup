...
HD_PWD='C:/Users/vibho/xilinx_projects/project_3/project_3.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log buffer_blocking_nonblocking.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source buffer_blocking_nonblocking.tcl -notrace
